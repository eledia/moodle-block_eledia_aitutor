...
if (\block_elediaaitutor\local\security::course_chat_enabled()) {
    ...
    $elediaaitutorhandlers['coursetutor'] = [
        'delegate' => 'CoreCourseOptionsDelegate',
        'method' => 'mobile_course_view',
        'displaydata' => [
            'title' => 'pluginname',
            'class' => 'block_elediaaitutor-course',
        ],
    ];
}

if (\block_elediaaitutor\local\security::global_chat_enabled()) {
    // A main-menu entry for the global chat.
    $elediaaitutorhandlers['globaltutor'] = [
        'delegate' => 'CoreMainMenuDelegate',
        'method' => 'mobile_global_view',
        'displaydata' => [
            'title' => 'pluginname',
            'icon' => 'fas-comments',
            'class' => 'block_elediaaitutor-menu',
        ],
    ];
}

$addons = empty($elediaaitutorhandlers) ? [] : [
    'block_elediaaitutor' => [
        'handlers' => $elediaaitutorhandlers,
        'lang' => [
            ['pluginname', 'block_elediaaitutor'],
        ],
    ],
];
