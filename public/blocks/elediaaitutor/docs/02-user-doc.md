...
5. Kurs als Nutzer/in mit `block/elediaaitutor:use` pruefen.
...
```text
https://YOURSITE/blocks/elediaaitutor/view.php
https://YOURSITE/blocks/elediaaitutor/view.php?courseid=N
```
