 ...
 *
 * Together with the block_elediaaitutor_consent row this forms the documented
...
class consent_given extends base {
    ...
    protected function init(): void {
        ...
        $this->data['objecttable'] = 'block_elediaaitutor_consent';
    }
    ...
    public static function get_name(): string {
        return get_string('event_consent_given', 'block_elediaaitutor');
    }
