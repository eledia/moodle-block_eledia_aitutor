...
class consent {
    ...
    public const TABLE = 'block_elediaaitutor_consent';
    ...
    public static function give(int $userid, \context $context): void {
        ...
        \block_elediaaitutor\event\consent_given::create([
            'context' => $context,
    ...
    public static function require_consent(int $userid): void {
        if (!self::has_consented($userid)) {
            throw new \moodle_exception('error_consentrequired', 'block_elediaaitutor');
        }
    }
