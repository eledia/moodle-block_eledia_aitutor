 ...
 * style. Teachers with block/elediaaitutor:viewreports see aggregated,
...
class question_log {
    ...
    public const TABLE = 'block_elediaaitutor_qlog';
    ...
    public static function is_enabled(): bool {
        return (int) get_config('block_elediaaitutor', 'enableanalytics') === 1;
    }
