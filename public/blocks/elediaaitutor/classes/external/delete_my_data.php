 ...
 *
 * Always acts on the calling user only. Local conversation pointers are always
 * removed; deletion is propagated to the external RAG/Tutor server when a
 * delete tool is configured, and otherwise honestly reported as unsupported.
...
class delete_my_data extends external_api {
    ...
    public static function execute(int $contextid): array {
        ...
        require_capability('block/elediaaitutor:deleteownhistory', $context);
    ...
    public static function execute_returns(): external_single_structure {
        return new external_single_structure([
            'localdeleted' => new external_value(PARAM_INT, 'Local conversations deleted'),
