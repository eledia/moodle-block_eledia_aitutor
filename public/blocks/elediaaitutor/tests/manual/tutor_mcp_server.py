...
"""
A minimal RAG/Tutor MCP server for manually testing block_elediaaitutor.
...
def main():
    parser = argparse.ArgumentParser(description="Minimal RAG/Tutor MCP server for block_elediaaitutor.")
