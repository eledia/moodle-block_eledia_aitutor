 ...
 * @covers      \block_elediaaitutor\local\deletion_service
...
final class deletion_service_test extends \advanced_testcase {
    ...
    public function test_external_deletion_with_injected_client(): void {
        ...
        set_config('deletetoolname', 'tutor_delete_conversation', 'block_elediaaitutor');
    ...
    public function test_user_level_delete_tool_preferred(): void {
        ...
        set_config('deletetoolname', 'tutor_delete_conversation', 'block_elediaaitutor');
        set_config('deleteusertoolname', 'tutor_delete_user_data', 'block_elediaaitutor');
