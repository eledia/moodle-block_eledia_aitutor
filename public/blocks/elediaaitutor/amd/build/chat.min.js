...
/* eslint-disable */
// Hand-transpiled AMD build of amd/src/chat.js. In a normal Moodle dev
// workflow this file is generated by `grunt amd`; it is committed here so the
// plugin runs out of the box. Rebuild with grunt after editing the source.
define('block_elediaaitutor/chat',
['core/ajax', 'core/templates', 'core/notification', 'core/modal', 'core/modal_save_cancel', 'core/modal_events', 'core/str'],
function(Ajax, Templates, Notification, Modal, ModalSaveCancel, ModalEvents, Str) {
