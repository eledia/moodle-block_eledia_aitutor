...
$string['setting_navbarlauncher'] = 'Show in the navigation bar';
$string['setting_navbarlauncher_desc'] = 'Add a tutor button to the site navigation bar (next to the notifications icon), available on every page without placing a block. The chat opens as an overlay using the default display mode.';
