...
$string['configuration_wizard_missing_body'] = 'Install and enable the related add-on plugin to make this setup step available.';
...
$string['configuration_wizard_status_missingplugin'] = 'Installation missing';
