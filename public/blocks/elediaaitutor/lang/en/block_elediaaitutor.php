...
// Plugin Shell / configuration overview.
$string['configuration'] = 'Dashboard';
$string['configuration_subtitle'] = 'Review tutor status and open the operator settings without leaving the plugin shell.';
...
$string['configuration_status_title'] = 'Settings overview';
$string['configuration_status_desc'] = '';
$string['configuration_status_rag'] = 'RAG server';
$string['configuration_status_mcp'] = 'MCP external service';
$string['configuration_status_llm'] = 'LLM connection';
$string['configuration_status_llm_ok'] = 'Reachable';
$string['configuration_status_llm_error'] = 'Error';
$string['configuration_status_llm_missing_key'] = 'LLM API key is not configured';
$string['configuration_status_ragingest'] = 'RAG-Ingest';
$string['configuration_status_ragingest_pending'] = '{$a} course(s) released, but not indexed yet';
$string['configuration_status_globalchat'] = 'Global chat';
$string['configuration_status_coursechat'] = 'Course chat';
$string['configuration_status_premium'] = 'Premium footer branding';
$string['configuration_status_configured'] = 'Configured';
$string['configuration_status_missing'] = 'Missing';
$string['configuration_status_premium_active'] = 'Available';
$string['configuration_status_premium_inactive'] = 'Not available';
$string['configuration_admin_settings_title'] = 'Settings';
$string['configuration_admin_settings_desc'] = 'Connection, privacy, limits and default values.';
$string['configuration_admin_settings_link'] = 'Open settings';
$string['configuration_tutors_title'] = 'Site tutors';
$string['configuration_tutors_desc'] = 'Presets, import/export and default tutor.';
$string['configuration_tutors_link'] = 'Manage site tutors';
$string['configuration_preview_title'] = 'Preview';
$string['configuration_preview_desc'] = 'Check the tutor experience with the current configuration.';
$string['configuration_preview_link'] = 'Open tutor';
$string['configuration_wizard_title'] = 'Setup wizard';
$string['configuration_wizard_desc'] = 'Follow these steps to configure LiteRAG, MCP and the tutor in the intended order.';
$string['configuration_wizard_status_ready'] = 'Ready';
$string['configuration_wizard_status_todo'] = 'Review';
$string['configuration_wizard_status_error'] = 'Error';
$string['configuration_wizard_task_open'] = 'Open setting';
$string['configuration_wizard_literag_title'] = 'LiteRAG backend';
$string['configuration_wizard_literag_desc'] = 'Prepare RAG storage, embeddings and backend options so course content can be retrieved.';
$string['configuration_wizard_literag_link'] = 'Open LiteRAG';
$string['configuration_wizard_ragingest_title'] = 'RAG-Ingest';
$string['configuration_wizard_ragingest_desc'] = 'Connect the ingestion endpoint and keep released courses indexed.';
$string['configuration_wizard_ragingest_link'] = 'Open RAG-Ingest';
$string['configuration_wizard_mcp_title'] = 'MCP';
$string['configuration_wizard_mcp_desc'] = 'Enable the Moodle tools and external services the tutor may use through MCP.';
$string['configuration_wizard_mcp_link'] = 'Open MCP';
$string['configuration_wizard_operator_title'] = 'Settings';
$string['configuration_wizard_operator_desc'] = 'Set the RAG endpoint, MCP service, tool names, privacy guidance, limits and technical tutor options.';
$string['configuration_wizard_tutors_title'] = 'Site tutors';
$string['configuration_wizard_tutors_desc'] = 'Maintain design, persona, presets, import and export for tutor configurations.';
$string['configuration_wizard_preview_title'] = 'Preview';
$string['configuration_wizard_preview_desc'] = 'Open the current user experience and verify connection, design and chat behaviour.';
$string['configuration_wizard_task_literag_llm_title'] = 'LLM connection';
$string['configuration_wizard_task_literag_llm_body'] = 'Set base URL, API key, model and answer limits.';
$string['configuration_wizard_task_literag_retrieval_title'] = 'Retrieval';
$string['configuration_wizard_task_literag_retrieval_body'] = 'Tune chunk sizes, candidates and context scope.';
$string['configuration_wizard_task_literag_tools_title'] = 'MCP tools';
$string['configuration_wizard_task_literag_tools_body'] = 'Enable read and write tools for the tutor.';
$string['configuration_wizard_task_ragingest_endpoint_title'] = 'Endpoint health';
$string['configuration_wizard_task_ragingest_endpoint_body'] = 'Check that the configured RAG ingestion endpoint answers successfully.';
$string['configuration_wizard_task_ragingest_index_title'] = 'Course index';
$string['configuration_wizard_task_ragingest_index_body'] = 'All released courses are recorded as indexed.';
$string['configuration_wizard_task_mcp_services_title'] = 'Services';
$string['configuration_wizard_task_mcp_services_body'] = 'Enable external MCP services and make them usable for tokens.';
$string['configuration_wizard_task_mcp_limits_title'] = 'Limits';
$string['configuration_wizard_task_mcp_limits_body'] = 'Review rate limits, page sizes and payload sizes.';
$string['configuration_wizard_task_mcp_security_title'] = 'Security';
$string['configuration_wizard_task_mcp_security_body'] = 'Review origins, token transport and emergency-disable settings.';
$string['configuration_wizard_task_operator_rag_title'] = 'RAG endpoint';
$string['configuration_wizard_task_operator_rag_body'] = 'Set tutor server URL, authentication and streaming.';
$string['configuration_wizard_task_operator_mcp_title'] = 'MCP service';
$string['configuration_wizard_task_operator_mcp_body'] = 'Choose the external service used for user-scoped tokens.';
$string['configuration_wizard_task_operator_privacy_title'] = 'Privacy text';
$string['configuration_wizard_task_operator_privacy_body'] = 'Maintain institution-specific first-use guidance.';
$string['configuration_wizard_task_tutors_design_title'] = 'Design values';
$string['configuration_wizard_task_tutors_design_body'] = 'Fine-tune colours, surfaces, launcher and logo.';
$string['configuration_wizard_task_tutors_persona_title'] = 'Persona';
$string['configuration_wizard_task_tutors_persona_body'] = 'Set name, role, tone and custom instructions.';
$string['configuration_wizard_task_tutors_library_title'] = 'Library';
$string['configuration_wizard_task_tutors_library_body'] = 'Apply, duplicate, import or export presets.';
$string['configuration_wizard_task_preview_open_title'] = 'Open standalone';
$string['configuration_wizard_task_preview_open_body'] = 'Test chat with the current site configuration.';
$string['configuration_wizard_task_preview_course_title'] = 'Course chat';
$string['configuration_wizard_task_preview_course_body'] = 'Check course context and active block instances.';
$string['configuration_ragingest_pending_title'] = 'Course released, but not indexed yet';
$string['configuration_ragingest_pending_body'] = '{$a} released course(s) are still missing from the RAG index.';
$string['configuration_ragingest_index_now'] = 'Index released courses now';
...
$string['setting_info_design_presets_title'] = 'Site tutors';
...
$string['course_not_indexed_admin'] = 'Course is released for RAG ingestion, but not indexed yet. Start indexing from the RAG-Ingest reindex page or the setup wizard.';
...
$string['managetutors'] = 'Site tutors';
$string['managetutors_intro'] = 'Manage site tutors: apply a preset or a saved tutor to the whole site, create and edit your own tutor designs, and import or export tutors (settings + images) as a bundle. Each block instance can also be given its own tutor below.';
...
$string['reg_promptstarters_desc'] = 'Suggested questions, one per line (up to six shown).';
...
$string['tutor_sitetutors'] = 'Site tutors';
