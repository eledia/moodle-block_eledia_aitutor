...
$string['setting_navbarlauncher'] = 'In der Navigationsleiste anzeigen';
$string['setting_navbarlauncher_desc'] = 'Fügt der Navigationsleiste der Website (neben dem Benachrichtigungssymbol) eine Tutor-Schaltfläche hinzu, die auf jeder Seite verfügbar ist, ohne einen Block zu platzieren. Der Chat öffnet sich als Overlay im Standard-Anzeigemodus.';
