...
use block_eledia_aitutor\output\mobile;
 ...
 */
#[CoversClass(\block_eledia_aitutor\output\mobile::class)]
final class mobile_test extends \advanced_testcase {
    ...
    public function test_mobile_course_view(): void {
        ...
        $this->assertStringContainsString('/blocks/eledia_aitutor/view.php', $html);
        ...
        $this->assertStringContainsString(
            get_string('notenabledincourse', 'block_eledia_aitutor'),
            $html
        );
    }
