...
final class ltm_test extends \advanced_testcase {
    ...
    public function test_sync_calls_configured_tool(): void {
        ...
        set_config('memoryoptintoolname', 'tutor_set_memory_optin', 'block_eledia_aitutor');
        ...
        $transport = \block_eledia_aitutor\fake_transport::json_result(
            ['structuredContent' => ['accepted' => true]]
        );
        $client = new \block_eledia_aitutor\local\rag_client(
