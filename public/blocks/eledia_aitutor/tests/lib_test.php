...
final class lib_test extends \advanced_testcase {
    ...
    public static function setUpBeforeClass(): void {
        global $CFG;
        require_once($CFG->dirroot . '/blocks/eledia_aitutor/lib.php');
    ...
    public function test_extend_navigation_course(): void {
        ...
        block_eledia_aitutor_extend_navigation_course($node, $course, $context);
        ...
        $node = new navigation_node(['text' => 'course']);
        block_eledia_aitutor_extend_navigation_course($node, $course, $context);
        $report = $node->find('eledia_aitutorreport', navigation_node::TYPE_SETTING);
        $this->assertNotEmpty($report);
        $this->assertStringContainsString('/blocks/eledia_aitutor/report.php', $report->action->out(false));
