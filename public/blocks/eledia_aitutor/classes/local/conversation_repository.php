...
class conversation_repository {
    ...
    private const TABLE = 'block_eledia_aitutor_conv';
    ...
    public static function upsert(
        ...
        \block_eledia_aitutor\event\conversation_created::create([
    ...
    public static function delete_owned(int $id, int $userid): bool {
        ...
        \block_eledia_aitutor\event\conversation_cleared::create([
            'context' => \core\context\system::instance(),
            'objectid' => $record->id,
            'relateduserid' => $userid,
        ])->trigger();
