...
class branding {
    ...
    public static function resolve(array $instance = []): array {
        ...
        if ($launchlabel === '') {
            $launchlabel = get_string('launch', 'block_eledia_aitutor');
        }
    ...
    public static function footer_text(array $instance = []): string {
        switch (self::footer_mode($instance)) {
            ...
            case self::FOOTER_CUSTOM:
                ...
                return $text !== '' ? $text : get_string('poweredby', 'block_eledia_aitutor');
            default:
                return get_string('poweredby', 'block_eledia_aitutor');
        }
    }
