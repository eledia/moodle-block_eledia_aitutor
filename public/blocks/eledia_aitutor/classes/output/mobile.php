...
class mobile {
    ...
    public static function mobile_course_view(array $args): array {
        ...
        if ($courseid <= 0 || !\block_eledia_aitutor\local\widget::course_has_tutor($courseid)) {
            $notice = '<ion-card><ion-card-content>'
                . s(get_string('notenabledincourse', 'block_eledia_aitutor'))
    ...
    private static function iframe_response(int $courseid): array {
        ...
        $url = new \moodle_url('/blocks/eledia_aitutor/view.php', $params);
