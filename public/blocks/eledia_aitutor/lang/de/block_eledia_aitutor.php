...
$string['configuration_wizard_missing_body'] = 'Bitte installieren Sie die fehlenden Zusatzplugins eLeDia LiteRAG, RAGIngest und eLeDia MCP.';
...
$string['setting_enablemcp'] = 'MCP freischalten';
$string['setting_enablemcp_desc'] = 'Aktiviert Moodle-MCP-Tools für den Tutor. Wenn ausgeschaltet, funktioniert der Tutor ohne webservice_elediamcp und ohne laufenden Moodle-MCP-Connector als reiner LLM-/RAG-Chat; Moodle-Werkzeuge, Memory-Sync und serverseitige Fernlöschung stehen dann nicht zur Verfügung.';
