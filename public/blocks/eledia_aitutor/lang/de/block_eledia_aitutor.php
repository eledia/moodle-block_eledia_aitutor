...
$string['configuration_diagnostics_detail'] = 'Detail';
$string['configuration_diagnostics_empty'] = 'Keine Tutor-Fehler protokolliert.';
$string['configuration_diagnostics_error'] = 'Fehler';
$string['configuration_diagnostics_intro'] = 'Kurze Diagnose der letzten fehlgeschlagenen Tutor-Aufrufe. Nachrichteninhalte, API-Keys und Tokens werden nicht gespeichert.';
$string['configuration_diagnostics_phase'] = 'Phase';
$string['configuration_diagnostics_time'] = 'Zeit';
$string['configuration_diagnostics_title'] = 'Letzte Tutor-Fehler';
...
$string['configuration_status_ragingest'] = 'RAGIngest';
...
$string['configuration_tutors_link'] = 'Tutoren verwalten';
$string['configuration_tutors_title'] = 'Tutoren';
...
$string['configuration_wizard_literag_title'] = 'LiteRAG';
...
$string['configuration_wizard_missing_body'] = 'Bitte installieren Sie die fehlenden Zusatzplugins: {$a}.';
$string['configuration_wizard_missing_title'] = 'Zusatzplugins fehlen';
...
$string['configuration_wizard_ragingest_link'] = 'RAGIngest öffnen';
$string['configuration_wizard_ragingest_title'] = 'RAGIngest';
...
$string['configuration_wizard_task_ragingest_endpoint_body'] = 'Prüfen, ob der konfigurierte RAGIngest-Endpunkt erfolgreich antwortet.';
...
$string['configuration_wizard_tutors_title'] = 'Tutoren';
...
$string['course_not_indexed_admin'] = 'Kurs ist für RAGIngest freigegeben, aber noch nicht indexiert. Starten Sie die Indexierung über die RAGIngest-Reindex-Seite oder den Einrichtungswizard.';
...
$string['default_promptstarters_manager'] = 'action | fa-plus | Kurs anlegen | Lege einen neuen Kurs in Moodle an. Frag mich zuerst nach vollständigem Namen, Kurznamen und Kategorie und lege den Kurs anschließend direkt an.
action | fa-users | Nutzer finden | Finde eine Nutzerin oder einen Nutzer. Frag mich nach dem Namen und zeige mir dann Profil und Einschreibungen.
action | fa-bar-chart | Plattform-Report | Erstelle mir einen kurzen Plattform-Überblick: Welche Kurse sind aktiv, welche verwaist?';
$string['default_promptstarters_student'] = 'action | fa-calendar-check-o | Was steht an? | Welche Abgaben, Tests und Termine stehen für mich diese Woche an? Sortiere nach Dringlichkeit.
action | fa-line-chart | Mein Fortschritt | Zeig mir meinen aktuellen Lernfortschritt in meinen Kursen. Wo hänge ich hinterher?
action | fa-graduation-cap | Lernen starten | Schlage mir vor, was ich heute am sinnvollsten lernen oder wiederholen sollte. Prüfe dazu meine Kurse und Termine.';
$string['default_promptstarters_teacher'] = 'action | fa-tasks | Anstehende Abgaben | Welche Abgaben warten auf meine Korrektur? Liste sie pro Kurs mit der Anzahl wartender Einreichungen.
action | fa-comments-o | Offene Forenfragen | Zeig mir unbeantwortete Forenbeiträge in meinen Kursen, sortiert nach Alter.
action | fa-bar-chart | Kursaktivität | Wie aktiv waren meine Kurse diese Woche? Gibt es Kurse mit auffällig wenig Aktivität?';
...
$string['groundedbadge'] = 'Kursbasiert';
...
$string['nav_ragingest'] = 'RAGIngest';
...
$string['privacy:metadata:block_eledia_aitutor_diag'] = 'Kurze Diagnoseeinträge fehlgeschlagener Tutor-Aufrufe für Administrator/innen; Nachrichteninhalte, Antworten, API-Keys und Tokens werden nicht gespeichert.';
$string['privacy:metadata:block_eledia_aitutor_diag:contextid'] = 'Der Kontext, in dem der Fehler aufgetreten ist.';
$string['privacy:metadata:block_eledia_aitutor_diag:courseid'] = 'Der Kurs, in dem der Fehler aufgetreten ist, sofern vorhanden.';
$string['privacy:metadata:block_eledia_aitutor_diag:detail'] = 'Bereinigte technische Kurzmeldung zum Fehler.';
$string['privacy:metadata:block_eledia_aitutor_diag:errorcode'] = 'Der Moodle-Fehlercode oder die Exception-Klasse.';
$string['privacy:metadata:block_eledia_aitutor_diag:phase'] = 'Der betroffene Verarbeitungsschritt.';
$string['privacy:metadata:block_eledia_aitutor_diag:timecreated'] = 'Wann der Fehler protokolliert wurde.';
$string['privacy:metadata:block_eledia_aitutor_diag:userid'] = 'Die Person, deren Tutor-Aufruf fehlgeschlagen ist.';
...
$string['setting_aihomenav'] = 'Dashboard-Link öffnet AI-Home';
$string['setting_aihomenav_desc'] = 'Lässt den Eintrag „Dashboard" in der Hauptnavigation auf die AI-Home-Seite (/blocks/eledia_aitutor/home.php) statt auf /my/ zeigen. Das klassische Dashboard bleibt unter /my/ direkt erreichbar.';
...
$string['setting_header_home_desc'] = 'Der Tutor bringt eine ganzseitige Start-Erfahrung mit unter <a href="{$a}">{$a}</a>: Begrüßung, Tagesbriefing und rollenbasierte Prompt-Pills in Seitenbreite. Um sie zur Startseite nach dem Login zu machen, setzen Sie „Startseite für Nutzer/innen" (Darstellung → Navigation, defaulthomepage) auf eine benutzerdefinierte URL mit dieser Adresse. Die Dashboard-Block-Variante funktioniert unabhängig davon weiter.';
