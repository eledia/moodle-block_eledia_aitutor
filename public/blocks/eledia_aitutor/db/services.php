...
$functions = [
    'block_eledia_aitutor_send_message' => [
        'classname' => 'block_eledia_aitutor\external\send_message',
        'description' => 'Send a chat message to the RAG/Tutor server and return the assistant response.',
        'type' => 'write',
        'ajax' => true,
        'capabilities' => 'block/eledia_aitutor:use',
        'loginrequired' => true,
    ],
    'block_eledia_aitutor_get_history' => [
        'classname' => 'block_eledia_aitutor\external\get_history',
        'description' => 'Load previous messages for one of the current user\'s conversations.',
        'type' => 'read',
        'ajax' => true,
        'capabilities' => 'block/eledia_aitutor:viewhistory',
        'loginrequired' => true,
    ],
    'block_eledia_aitutor_get_conversations' => [
        'classname' => 'block_eledia_aitutor\external\get_conversations',
    ...
    'block_eledia_aitutor_clear_conversation' => [
        'classname' => 'block_eledia_aitutor\external\clear_conversation',
    ...
    'block_eledia_aitutor_give_consent' => [
        'classname' => 'block_eledia_aitutor\external\give_consent',
    ...
    'block_eledia_aitutor_set_ltm' => [
        'classname' => 'block_eledia_aitutor\external\set_ltm',
    ...
    'block_eledia_aitutor_delete_my_data' => [
        'classname' => 'block_eledia_aitutor\external\delete_my_data',
