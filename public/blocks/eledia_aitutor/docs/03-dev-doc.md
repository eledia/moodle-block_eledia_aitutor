...
Browser / AMD chat.js
  ...
  -> block_eledia_aitutor local services
...
| Pfad | Zweck |
|---|---|
| `block_eledia_aitutor.php` | Moodle Block Entry. |
...
Block ist unter `public/blocks/eledia_aitutor` installiert. Fuer den Tutor muessen
