 ...
 *
 * @module     block_eledia_aitutor/copilot_report
...
export default {
    ...
    init: function(courseid) {
        ...
        button.addEventListener('click', async() => {
            ...
            result.hidden = true;
            status.textContent = await getString('copilot_working', 'block_eledia_aitutor');
            ...
            Ajax.call([{
                ...
                status.textContent = (error && error.message)
                    || await getString('copilot_failed', 'block_eledia_aitutor');
                button.disabled = false;
            });
        });
    },
